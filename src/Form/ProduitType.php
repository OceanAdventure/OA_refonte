...
class ProduitType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('titre_principalEn', TextType::class)
            ->add('titre_secondaire', TextType::class)
            ->add('titre_secondaireEn', TextType::class)
            ->add('condition_reglement', TextareaType::class)
            ->add('condition_reglementEn', TextareaType::class)
            ->add('prix', IntegerType::class)
            ->add('nb_cours', IntegerType::class)
            ->add('descrition', TextareaType::class)
            ->add('descritionEn', TextareaType::class)
